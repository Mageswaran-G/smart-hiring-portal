...
const MiniBarChart = ({ data = [], color, w = 180, h = 40 }) => {
...
// Progress ring (circle chart)
const ProgressRing = ({ value = 0, size = 76, stroke = 7, color = '#a78bfa' }) => {
  ...
  return (
    <svg width={size} height={size}>
      ...
      <text x={size/2} y={size/2 + 18} textAnchor="middle"
        fill="rgba(255,255,255,0.7)" fontSize={9}>hired</text>
    </svg>
  );
};
